...
module Spec.Marconi.Index.AddressDatum.E2E
    ( tests
    ) where
...
tests :: TestTree
tests = testGroup "Spec.Marconi.Index.AddressDatum.E2E"
  [ testPropertyNamed "" "addressDatumIndexE2ETest" addressDatumIndexE2ETest
  ]
...
-}
addressDatumIndexE2ETest :: Property
addressDatumIndexE2ETest = H.integration . HE.runFinallies . workspace "chairman" $ \tempAbsBasePath' -> do
